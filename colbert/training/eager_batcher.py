...
from colbert.utils.metadata import default_doc_meta
...
class EagerBatcher():
    ...
    def __next__(self):
        ...
        positive_metadata = [default_doc_meta() for _ in positives]
        negative_metadata = [default_doc_meta() for _ in negatives]
        return self.collate(queries, positives, negatives, positive_metadata, negative_metadata)
