...
class Arguments():
    ...
    def add_model_parameters(self):
        ...
        self.add_argument('--enable-moe-doc', dest='enable_moe_doc', default=False, action='store_true')
        self.add_argument('--num-experts', dest='num_experts', default=1, type=int)
        self.add_argument('--lora-rank', dest='lora_rank', default=0, type=int)
        self.add_argument('--lora-alpha', dest='lora_alpha', default=16.0, type=float)
        self.add_argument('--lora-dropout', dest='lora_dropout', default=0.0, type=float)
        self.add_argument('--freeze-bert', dest='freeze_bert', default=False, action='store_true')
        self.add_argument('--freeze-linear', dest='freeze_linear', default=False, action='store_true')
        self.add_argument('--router-hidden-size', dest='router_hidden_size', default=256, type=int)
        self.add_argument('--router-temp', dest='router_temp', default=1.0, type=float)
        self.add_argument('--num-time-buckets', dest='num_time_buckets', default=0, type=int)
        self.add_argument('--time-bucket-dim', dest='time_bucket_dim', default=8, type=int)
        self.add_argument('--num-source-buckets', dest='num_source_buckets', default=0, type=int)
        self.add_argument('--source-dim', dest='source_dim', default=8, type=int)
        self.add_argument('--prototype-path', dest='prototype_path', default=None)
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument('--balance-alpha', dest='balance_alpha', default=0.0, type=float)
        self.add_argument('--balance-warmup', dest='balance_warmup', default=0, type=int)
        self.add_argument('--router-supervision-alpha', dest='router_supervision_alpha', default=0.0, type=float)
        self.add_argument('--router-supervision-warmup', dest='router_supervision_warmup', default=0, type=int)
    ...
    def add_training_input(self):
        ...
        self.add_argument('--collection_meta', dest='collection_meta', default=None)
